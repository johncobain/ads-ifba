...
public class Alimento {
    ...
    public Alimento(String nome,
        ...
        this(nome);
        this.addNutriente(CatalogoNutrientes.instance().create("CARBOIDRATO"), qtdeCHO);
        this.addNutriente(CatalogoNutrientes.instance().create("PROTEINA"), qtdePTN);
        this.addNutriente(CatalogoNutrientes.instance().create("GORDURA"), qtdeLIP);
    }
